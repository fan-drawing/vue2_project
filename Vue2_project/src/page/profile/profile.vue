...
<style lang="scss" scoped>
   @import 'src/style/mixin';
    #head_top{background-image: linear-gradient(to right, #e40000 0%, #d81b1b 25%, #c13636 50%, #9a3e3e 75%, #862525 100%);border-bottom:1px dotted #825f5f;}
    .profile_page{
        p, span{
   ...
   .profile-number{
        ...
        .profile-link{
            ...
            align-items: center;
        background-image: linear-gradient(to right, #e40000 0%, #d81b1b 25%, #c13636 50%, #9a3e3e 75%, #862525 100%);
