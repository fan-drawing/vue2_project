<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/msite', query: {geohash}})" class="guide_item">
            ...
            <span :class="$route.path.indexOf('msite') !== -1 ? 'active' :''">外卖</span>
        </section>
        <section @click = "gotoAddress({path: '/search/geohash'})" class="guide_item">
            ...
            <span :class="$route.path.indexOf('search') !== -1 ? 'active' :''">搜索</span>
        </section>
        <section @click = "gotoAddress('/order')" class="guide_item">
            ...
            <span :class="$route.path.indexOf('order') !== -1 ? 'active' :''">订单</span>
        </section>
        <section @click = "gotoAddress('/profile')" class="guide_item">
            ...
            <span :class="$route.path.indexOf('profile') !== -1 ? 'active' :''">我的</span>
        </section>
    </section>
</template>
...
<style lang="scss" scoped>
    ...
    #foot_guide{
        ...
        box-shadow: 0rem 0rem 0.5rem #999999;
    }
